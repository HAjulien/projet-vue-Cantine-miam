...
<div>
  ...
  <div class="sm:flex article lg:h-[400px] rounded-xl shadow-md m-2  border-2 p-4 mb-8  bg-gray-200 dark:bg-gray-500 text-lg hover:bg-gray-100 hover:border-4 hover:border-amber-300 ">
