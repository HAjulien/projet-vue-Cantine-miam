  ...
  >
    <div>
      ...
      <transition name="fade" mode="out-in">
        ...
        <div  v-if="dark" class=" bg-amber-300	shadow-inner  rounded-xl flex h-7 items-center w-20 justify-evenly">
        ...
        <div  v-else class=" bg-gray-800 shadow-inner  rounded-xl flex h-7 items-center w-20 justify-evenly"> 
